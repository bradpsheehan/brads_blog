...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<middleman-core>, ["= 3.1.5"])
      s.add_runtime_dependency(%q<middleman-more>, ["= 3.1.5"])
      ...
      s.add_dependency(%q<middleman-core>, ["= 3.1.5"])
      s.add_dependency(%q<middleman-more>, ["= 3.1.5"])
